...
<div class="container">
	...
	<div class="row">
	    ...
	    <div class="row"> 
	   		<div class="col-md-2 col-sm-1"></div>  
	        <form  name="elementos" action="menuElementos"  method="get" >			
		        <div class="col-md-4 col-sm-5" >
		        <button class="btn btn-success btn-lg btn-block"><h4 style="padding:30px; margin:0px;">Elementos</h4></button> 
		        </div>         
	        </form>
	         <form  name="tipoElementos" action="menuTipoElementos" method="get">			
		        <div class="col-md-4 col-sm-5" >
