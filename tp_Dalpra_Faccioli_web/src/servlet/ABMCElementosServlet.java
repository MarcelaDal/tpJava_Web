 ...
 public class ABMCElementosServlet extends HttpServlet {
 	...
 	private void modificacion(HttpServletRequest request, HttpServletResponse response) throws IOException {
 		try{
 			...
 			System.out.println("El elemento fue modificado con �xito.");
 		} catch (Exception e) {
 			e.printStackTrace();
 	...
 	private void baja(HttpServletRequest request, HttpServletResponse response) throws IOException {
 		...
 		try {
 			ctrl.delete(ele);
 			System.out.println("El elemento fue eliminado con �xito.");
 			PrintWriter out = response.getWriter(); 
 			out.println("El elemento fue eliminado con �xito. ");
 					out.close();
 		} catch (Exception e) {
 			e.printStackTrace();
 	...
 	private void alta(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
 		...
 		try {
 			ctrl.add(ele);
 			System.out.println("Nuevo Elemento agregado con �xito.");
 			//PrintWriter out = response.getWriter(); 
 			//out.println("<p>El elemento fue agregado con �xito. </p>");
 			//		out.close();
